...
COMMENT ON COLUMN customer.cust_level IS
    'Customer leve, G-Gold, S-Silver, B-Bronze';
...
CREATE TABLE product (
    ...
    prod_unitprice  NUMBER(5, 2),
    prod_category   VARCHAR2(10) NOT NULL,
    pcat_id         NUMBER(7) NOT NULL
);
...
COMMENT ON COLUMN product.prod_desc IS
    'Records the product description';
